  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <div className="flex gap-2 mb-4 overflow-x-auto">
        ...
        >
          📆 Сегодня ({getTodayReminders().length})
        </button>
                ...
                <>
                  ...
                  <div className="flex gap-2 mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                    <button
                      ...
                      className="flex-1 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-300 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-1"
                    >
                      ✏️ Изменить
                    </button>
                    <button
                      onClick={() => startExtend(reminder)}
                      className="flex-1 bg-green-100 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-1"
                    >
                      ⏱️ Перенести
                    </button>
                    <button
                      onClick={() => handleDelete(reminder.id)}
                      className="px-3 bg-red-100 hover:bg-red-200 dark:bg-red-900/30 dark:hover:bg-red-900/50 text-red-700 dark:text-red-300 py-2 rounded-lg text-sm"
                      title="Удалить"
                    >
                      🗑️
                    </button>
